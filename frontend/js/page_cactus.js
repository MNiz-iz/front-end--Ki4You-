...
function appendData(myData) {
    ...
    document.getElementById("min1").innerHTML = '<b>ตัวอย่างเรทราคา : </b>' + myData.t1.price[0].ListPrices.price + ' บาท' ;
    document.getElementById("min2").innerHTML = '<b>ตัวอย่างเรทราคา : </b>' + myData.t2.price[0].ListPrices.price + ' บาท' ;
    document.getElementById("min3").innerHTML = '<b>ตัวอย่างเรทราคา : </b>' + myData.t3.price[0].ListPrices.price + ' บาท';
