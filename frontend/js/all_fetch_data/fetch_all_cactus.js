...
xhr.onreadystatechange = () => {
    if (xhr.readyState === XMLHttpRequest.DONE){
        ...
        htmls += `</div>`
        htmls += `<div class="pagination">  </div>`
...
//link api back-end from hosting
const url_endpoint = api_url + '/tree_data/all_data/cactus'
...
function call_page(index){
    ...
    window.open(url_front + '/template/all_data/data_page_cactus.html');
}
