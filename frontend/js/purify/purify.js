...
const indexPollution = localStorage.getItem('indexPollution');
console.log(indexPollution);
...
//url
const url_endpoint = api_url + `/tree_data/purify/${indexPollution}`
...
function call_page(index){
    ...
    window.open(url_front + '/template/purify_page_p/purify_page_p.html');
}